...
export const TEMPAD_MCP_BRIDGE_PROTOCOL_VERSION = 3
...
// Reserve space before committing canvas writes for runtime evidence added by the Hub.
export const MCP_APPLY_CANVAS_RUNTIME_BUDGET_BYTES = 2 * 1024
